	...
	return (
        <div className='background'>
            ...
            <div className='container'>
                <div className='row mt-5 justify-content-between timer-row'>
                    <div className='col card bg-dark rounded justify-content-center'>
                    ...
                    <div className='col card bg-dark rounded justify-content-center'>
                        <div className='d-flex flex-row justify-content-center'>
                            <h1 className='time-digit'>{Math.floor(time%1000000 / 100000)}</h1>
                        </div>
                    </div>
                    <div className='col card bg-dark rounded justify-content-center'>
                        <div className='d-flex flex-row justify-content-center'>
                            <h1 className='time-digit'>{Math.floor(time%100000 / 10000)}</h1>
                        </div>
                    </div>
                    <div className='col card bg-dark rounded justify-content-center'>
                        <div className='d-flex flex-row justify-content-center'>
                            <h1 className='time-digit'>{Math.floor(time%10000 / 1000)}</h1>
                        </div>
                    </div>
                    <div className='col card bg-dark rounded justify-content-center'>
                        <div className='d-flex flex-row justify-content-center'>
                            <h1 className='time-digit'>{Math.floor(time%1000 / 100)}</h1>
                        </div>
                    </div>
                    <div className='col col-dot'>
                        <h1>.</h1>
                    </div>
                    <div className='col card bg-dark rounded justify-content-center'>
                        <div className='d-flex flex-row justify-content-center'>
                            <h1 className='time-digit'>{Math.floor(time%100 / 10)}</h1>
                        </div>
                    </div>
                    <div className='col card bg-dark rounded justify-content-center'>
                        <div className='d-flex flex-row justify-content-center'>
                            <h1 className='time-digit'>{Math.floor(time%10)}</h1>
                        </div>
                    </div>
                </div>
